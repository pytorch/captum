...
class LimeBase(PerturbationAttribution):
    ...
    def __init__(
        self, forward_func: Callable, train_interpretable_model_func: Callable, similarity_func: Callable,
        sampling_func: Callable, sample_interpretable_space: bool, from_interp_rep_transform: Callable, to_interp_rep_transform: Callable ,
    ) -> None:
        r"""
        Args:
