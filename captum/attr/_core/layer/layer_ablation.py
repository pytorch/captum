...
class LayerAblation(LayerAttribution):
    ...
    def attribute(
        ...
        r"""
            ...
            replacing each neuron's value in the layer with a given baseline /
            reference, and computing the difference in output. By default, each
            neuron within the layer is replaced independently.
            ...
            Args:
                ...
                baselines (scalar, tensor, tuple of scalars or tensors, optional):
                            ...
                            neuron when ablated.
                            Baselines should be a single tensor with dimensions
