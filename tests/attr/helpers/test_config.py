...
from .basic_models import BasicModel_MultiLayer, BasicModel_MultiLayer_MultiInput, BasicModel_ConvNet, ReLULinearDeepLiftModel
...
config = [
    ...
    }, 
    {
        ...
        "algorithms": [IntegratedGradients, InputXGradient, FeatureAblation, DeepLift, Saliency],
        "model": BasicModel_MultiLayer_MultiInput(),
        "attribute_args": {"inputs": (10*torch.randn(6, 3), 5 * torch.randn(6, 3)) , "additional_forward_args": (2*torch.randn(6, 3), 5), "target": [0, 1, 1, 0, 0, 1]},
    },
    {
    ...
    # DeepLift SHAP
    {
        ...
        "model": BasicModel_MultiLayer(),
        "attribute_args": {"inputs": torch.randn(4, 3), "baselines": 0.5*torch.randn(6,3), "target": 0},
        "baseline_distr": True,
    },
    {
        ...
        "algorithms": [DeepLiftShap],
        "model": BasicModel_MultiLayer_MultiInput(),
        "attribute_args": {"inputs": (10*torch.randn(12, 3), 5 * torch.randn(12, 3)), "baselines": (torch.randn(4, 3), torch.randn(4, 3)), "additional_forward_args": (2*torch.randn(12, 3), 5), "target": 0},
        "baseline_distr": True,
    },
    {
    ...
    # Gradient SHAP
    {
        "name": "basic_multi_inp_with_grad_shap",
        "algorithms": [GradientShap],
        "model": BasicModel_MultiLayer_MultiInput(),
        "attribute_args": {"inputs": (10*torch.randn(6, 3), 5 * torch.randn(6, 3)) , "additional_forward_args": (2*torch.randn(1, 3), 5), "target": [0, 1, 1, 0, 0, 1]},
        "target_delta": 0.6,
        "baseline_distr": True,
    },
    {
    ...
    {
        "name": "basic_multi_input_occlusion",
        "algorithms": [Occlusion],
    ...
    {
        "name": "basic_multiple_tuple_target_with_perturbations_per_eval_occlusion",
        "algorithms": [Occlusion],
        "model": BasicModel_MultiLayer(),
        "attribute_args": {
            "inputs": torch.randn(4, 3),
    ...
    {
        "name": "basic_layer_conv_single_target",
        "algorithms": [LayerConductance, LayerIntegratedGradients, LayerDeepLift, InternalInfluence, LayerFeatureAblation, LayerGradientXActivation, LayerGradCam],
        "model": BasicModel_ConvNet(),
        "layer": "conv2",
    ...
    {
        "name": "basic_layer_with_perturbations_per_eval",
        "algorithms": [LayerFeatureAblation],
        "model": BasicModel_ConvNet(),
        "layer": "conv2",
        "attribute_args": {"inputs": 100 * torch.randn(4, 1, 10, 10), "target": 1, "perturbations_per_eval": 20},
    },
    {
        ...
        "model": ReLULinearDeepLiftModel(),
        "layer": "l3",
        "attribute_args": {"inputs": (10*torch.randn(6, 3), 5 * torch.randn(6, 3)), "baselines": (2*torch.randn(2, 3), 6* torch.randn(2, 3))},
        "baseline_distr": True,
    },
    {
        ...
        "model": BasicModel_MultiLayer(multi_input_module=True),
        "layer": "relu",
        "attribute_args": {"inputs": torch.randn(4, 3),"baselines": torch.randn(2, 3), "target": 0, "internal_batch_size": 2},
        "baseline_distr": True,    
    },
    {
        ...
        "model": BasicModel_MultiLayer_MultiInput(),
        "layer": "model.relu",
        "attribute_args": {"inputs": (10*torch.randn(6, 3), 5 * torch.randn(6, 3)), "baselines": (2*torch.randn(11, 3), 6* torch.randn(11, 3)), "additional_forward_args": (2*torch.randn(6, 3), 5), "target": [0, 1, 1, 0, 0, 1]},
        "baseline_distr": True,
    },
    {
    ...
    {
        "name": "basic_neuron",
        "algorithms": [NeuronGradient, NeuronIntegratedGradients, NeuronGuidedBackprop, NeuronDeconvolution, NeuronDeepLift, NeuronFeatureAblation],
        "model": BasicModel_MultiLayer(),
        "layer": "relu",
    ...
    },
    {
        ...
        "model": BasicModel_ConvNet(),
        "layer": "conv2",
        "attribute_args": {"inputs": 100 * torch.randn(4, 1, 10, 10), "target": 1, "neuron_index": (0,1,0)},
    },
    {
        ...
        "model": BasicModel_MultiLayer_MultiInput(),
        "layer": "model.relu",
        "attribute_args": {"inputs": (10*torch.randn(12, 3), 5 * torch.randn(12, 3)) , "additional_forward_args": (2*torch.randn(12, 3), 5), "neuron_index": (3,)},
    },
    {
        ...
        "model": BasicModel_MultiLayer_MultiInput(),
        "layer": "model.relu",
        "attribute_args": {"inputs": (10*torch.randn(6, 3), 5 * torch.randn(6, 3)) , "additional_forward_args": (2*torch.randn(6, 3), 5), "target": [0, 1, 1, 0, 0, 1], "neuron_index": 3},
    },
    {
    ...
    },
    {
        ...
        "model": BasicModel_MultiLayer_MultiInput(),
        "layer": "model.relu",
        "attribute_args": {"inputs": (10*torch.randn(6, 3), 5 * torch.randn(6, 3)) , "additional_forward_args": (2*torch.randn(6, 3), 5), "target": [0, 1, 1, 0, 0, 1], "internal_batch_size": 2, "neuron_index": 3},
    },
    ...
    },
    {
        ...
        "model": BasicModel_MultiLayer_MultiInput(),
        "layer": "model.relu",
        "attribute_args": {"inputs": (10*torch.randn(6, 3), 5 * torch.randn(6, 3)) , "additional_forward_args": (2*torch.randn(1, 3), 5), "target": [0, 1, 1, 0, 0, 1], "neuron_index": 3},
        "target_delta": 0.6,
        "baseline_distr": True,
    },
    # Neuron DeepLift SHAP
    {
        ...
        "model": BasicModel_MultiLayer(),
        "attribute_args": {"inputs": torch.randn(4, 3), "baselines": 0.5*torch.randn(6,3), "target": 0, "neuron_index": (3,)},
        "baseline_distr": True,
    },
    {
        ...
        "algorithms": [NeuronDeepLiftShap],
        "model": BasicModel_MultiLayer_MultiInput(),
        "attribute_args": {"inputs": (10*torch.randn(12, 3), 5 * torch.randn(12, 3)), "baselines": (torch.randn(4, 3), torch.randn(4, 3)), "additional_forward_args": (2*torch.randn(12, 3), 5), "target": 0, "neuron_index": 3},
        "baseline_distr": True,
    },
    {
    ...
    },
    {
        ...
        "algorithms": [NeuronFeatureAblation],
        "model": BasicModel_MultiLayer(),
        "attribute_args": {"inputs": (10*torch.randn(12, 3), 5 * torch.randn(12, 3)), "baselines": (10*torch.randn(12, 3), 5 * torch.randn(12, 3)), "additional_forward_args": (2*torch.randn(12, 3), 5), "neuron_index": (3,),  "perturbations_per_eval": 2},
    },
]
