...
class Test(unittest.TestCase):
    ...
    def test_simple_multi_input_linear2_activation(self):
        ...
        self._layer_activation_test_assert(net, net.model.linear2, (inp1,inp2,inp3), [392.0, 394.0], (4,))
    ...
    def _layer_activation_test_assert(
        ...
        attributions = layer_act.attribute(test_input, additional_forward_args=additional_input)
