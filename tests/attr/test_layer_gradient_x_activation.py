...
class Test(unittest.TestCase):
    ...
    def test_simple_gradient_activation_multi_input_linear2(self):
        ...
        self._layer_activation_test_assert(net, net.model.linear2, (inp1,inp2,inp3), [392.0, 0.0], (4,))
    ...
    def test_simple_gradient_activation_multi_input_relu(self):
        ...
        self._layer_activation_test_assert(net, net.model.relu, (inp1,inp2), [90.0, 101.0, 101.0, 101.0], (inp3, 5))

    def _layer_activation_test_assert(
        self, model, target_layer, test_input, expected_activation, additional_input=None
    ):
        layer_act = LayerGradientXActivation(model, target_layer)
        attributions = layer_act.attribute(test_input, target=0,additional_forward_args=additional_input)
